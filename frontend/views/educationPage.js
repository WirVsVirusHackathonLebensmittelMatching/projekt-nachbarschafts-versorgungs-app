sap.ui.require([
    ...
    oGlobalEventBus.subscribeOnce("create-educationPage", function () {
        ...
        Händewaschen ist einer der einfachsten Wege die Verbreitung zu verlangsamen. Um die nötige Dauer einzuhalten kann man z.B. 2 mal Happy Birthday singen. Dazu solltet ihr ausreichend Seife benutzen und die Handgelenke nicht vergessen. Eine genau Beschreibung findet ihr hier.
        ...
        Das bedeutet vereinfacht, dass Ihr nur noch wenn es nötig ist aus dem Haus geht. Also wenn Ihr zum Arzt oder einkaufen müsst.
        ...
        In dem Artikel geht es um eine Legende, in der der Erfinder des Schachspiels eine Belohnung vom König Indiens bekommen soll. Er wünscht sich 1 Reiskorn auf dem ersten Feld eines Schachbretts und auf jedes weitere Feld sollen doppelt so viele Reiskörner wie auf das vorherige Feld gelegt werden.
